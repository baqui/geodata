...
class _CalendarState extends State<Calendar> {
  ...
  DateTime
      periodStartDate; // in week view equals to viewStartDate, in month view equals to first day of a month
  ...
  _CalendarState(DateTime initialDate, String displayPeriod) {
    ...
    DateTime startingDate = displayPeriod == 'week'
        ? initialDate
        : DateTime.utc(initialDate.year, initialDate.month, 1);
            ...
            child: Column(
              children: <Widget>[
                Header(
                    ...
                    year: DateTime.utc(periodStartDate.year, 1, 1)
                        .year
                        .toString(),
                    onPrev: () {
                ...
                Row(
                    children: widget.dayLabels
                        .map((label) => Day(text: label, header: true))
                        .toList()),
                buildDatesRow()
              ],
            )));
    ...
    return Column(
      children: List<Widget>.generate(
          ...
          (weekIndex) => Row(
                ...
                // 7 - n days of the week

                DateTime date = viewStartDate
  ...
  handleViewChange(String direction) {
    DateTime nextPeriodStartDate = DateUtils.calculatePeriodStartDate(
        direction, widget.displayPeriod, viewStartDate, periodStartDate);
    setState(() {
